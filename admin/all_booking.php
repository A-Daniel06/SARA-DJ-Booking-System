...
<div class="topbar"><h1 style="margin:0; font-size:2.2rem; color:#fff; letter-spacing:1.5px;">All Bookings</h1></div>
<div class="main-content">
  <div class="booking-card">
    <h2><i class="fa fa-calendar-alt"></i> All Bookings</h2>
      ...
      <tbody>
        ...
        if ($query->rowCount() > 0) {
          foreach ($results as $row) {
            ...
            if ($status == 'Approved') $badge = '<span class="badge badge-success">Approved</span>';
            if ($status == 'Cancelled') $badge = '<span class="badge badge-danger">Cancelled</span>';
            echo '<td class="d-none d-sm-table-cell">' . $badge . '</td>';
            echo '<td class="d-none d-sm-table-cell">';
            echo '<a href="view-booking-detail.php?id=' . $row->ID . '" class="btn btn-info btn-sm">View</a>';
            echo '</td>';
            echo '</tr>';
            $cnt++;
          }
