...
<div class="topbar"><h1 style="margin:0; font-size:2.2rem; color:#5b86e5; letter-spacing:1.5px;">Approved Bookings</h1></div>
<div class="main-content">
  <div class="booking-card">
    <h2><i class="fa fa-calendar-check"></i> Approved Bookings</h2>
    <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
      ...
      <tbody>
        <?php
        $sql = "SELECT * FROM tblbooking WHERE EventType = 'Approved' ORDER BY ID DESC";
        ...
        if ($query->rowCount() > 0) {
          foreach ($results as $row) {
            ...
            echo '<td class="d-none d-sm-table-cell"><span class="badge badge-success">Approved</span></td>';
            // No action column for approved bookings; final status shown instead
            echo '</tr>';
            $cnt++;
          }
        } else {
          echo '<tr><td colspan="7">No approved bookings found.</td></tr>';
        }
        ?>
      </tbody>
    </table>
